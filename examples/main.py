...
# print(fetch_all_url_filering_rules(tenant="softbank-demo-05"))
...
# print(lookup_url_classification(["hoge.com"], "softbank-demo-05"))

# print(fetch_all_url_filering_rules())


# print(fetch_adminroles("softbank-demo-05"))
